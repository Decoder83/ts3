        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchNationality(name)];
                case 1:
                    nationality = _a.sent();
...
function fetchNationality(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("https://api.nationalize.io/?name=".concat(name))];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    data = _a.sent();
                    return [2 /*return*/, data.country.map(function (country) { return "".concat(country.country_id, " (").concat((country.probability * 100).toFixed(2), "%)"); })];
            }
        });
    });
}
